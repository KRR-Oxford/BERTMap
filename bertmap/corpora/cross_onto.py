...
class CrossOntoCorpus(OntoCorpus):
    def __init__(
        ...
        super().__init__(src_onto_box, tgt_onto_box, src2tgt_mappings_file, sample_rate, corpus_file=corpus_file)
    ...
    def config(
        ...
        if type(src2tgt_mappings_file) is str:
            ...
            self.maps = src2tgt_mappings_file  # already processed
        # initialize corpus
    ...
    def negative_sampling(self, cls_labels: List[str], map_idx: int, search_from: str = "SRC") -> None:
