...
class CrossOntoCorpus(OntoCorpus):
    ...
    def splitting_corpus(cls,
                         ...
                         sample_rate: int=10) -> Tuple[CrossOntoCorpus, CrossOntoCorpus, CrossOntoCorpus]:
        ...
        train_maps, val_test_maps = train_test_split(OntoEvaluator.read_mappings(src2tgt_mappings_file), test_size=1-train_ratio)
        ...
        return cls(src2tgt_mappings_file=train_maps, **kwargs), \
