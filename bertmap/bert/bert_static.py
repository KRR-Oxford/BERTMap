...
class BERTStatic:
    def __init__(
        ...
        if not with_classifier:
            ...
            self.model = AutoModelForSequenceClassification.from_pretrained(bert_checkpoint, output_hidden_states=True)
        self.model.eval()
    ...
    def ontotext_embeds(self, classtexts_batch: Dict[str, Dict], strategy: str = "mean", neg_layer_num: int = -1):
