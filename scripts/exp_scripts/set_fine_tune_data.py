...
cross_onto.save_labels(test_r, exp_dir + f"/{src}2{tgt}.us.test.r.tsv")
cross_onto.save_labels(train_r, exp_dir + f"/{src}2{tgt}.ss.train.r.tsv")
cross_onto.save_labels(val_r, exp_dir + f"/{src}2{tgt}.ss.val.r.tsv")
cross_onto.save_labels(test_r, exp_dir + f"/{src}2{tgt}.ss.test.r.tsv")
...
merged_intra_onto.save_labels(train_f_r, exp_dir + f"/{src}2{tgt}.ss.train.f+r.tsv")
merged_intra_onto.save_labels(train_f_b_r, exp_dir + f"/{src}2{tgt}.ss.train.f+b+r.tsv")
merged_intra_onto.save_labels(train_f_b_i_r, exp_dir + f"/{src}2{tgt}.ss.train.f+b+i+r.tsv")
...
merged_intra_onto.save_labels(train_f, exp_dir + f"/{src}2{tgt}.us.train.f.tsv")
merged_intra_onto.save_labels(train_f_b, exp_dir + f"/{src}2{tgt}.us.train.f+b.tsv")
merged_intra_onto.save_labels(train_f_b, exp_dir + f"/{src}2{tgt}.us.train.f+b+i.tsv")

merged_intra_onto.save_labels(val_f, exp_dir + f"/{src}2{tgt}.us.val.f.tsv")
merged_intra_onto.save_labels(val_f_b, exp_dir + f"/{src}2{tgt}.us.val.f+b.tsv")
merged_intra_onto.save_labels(val_f_b, exp_dir + f"/{src}2{tgt}.us.val.f+b+i.tsv")